...
export class OffersComponent implements AfterViewInit, OnInit{

  translatedParagraph?: SafeHtml;
  constructor(private translate: TranslateService, private sanitizer: DomSanitizer) {}
  ngOnInit(): void {
      this.translate.get('PARAGRAPH2','PARAGRAPH7').subscribe((res: string) => {
...
const ELEMENT_DATA: PeriodicElement[] = [
  ...
  {position: 8, name: 'Anemia', symbol: 'Iron'},
  {position: 9, name: 'Some forms of neurosis and states of psychophysical exhaustion of the organism;', symbol: ''},
  {position: 10, name: 'Diseases of the kidneys and urinary tract', symbol: 'post'},
